...
void pidTune() {
    ...
    chassis.moveToPoint(-3, 29 ,2000, {.maxSpeed = 80});
    chassis.waitUntilDone();
    intakeMotor.move(127);
    chassis.tank(-30, -30);
    pros::delay(100);
    ...
    chassis.waitUntilDone();
    chassis.moveToPoint(94, 19, 4000, {.forwards = false, .minSpeed = 127, .earlyExitRange = 1});
    matchLoader.set_value(true);
    chassis.moveToPoint(95, 33, 4000, {.forwards = false}); //move to the goal and align
    chassis.turnToHeading(90, 2000);
    chassis.moveToPoint(82, 33, 900, {.forwards = false});
    chassis.waitUntilDone();
    chassis.tank(80, 80);
    pros::delay(150);
    chassis.tank(0,0);
    ...
    chassis.setPose(0,0,0);
    matchLoader.set_value(true);
    chassis.moveToPoint(0, 30.5, 3000, {.maxSpeed = 60}); //go to second matchloader
    chassis.waitUntilDone();
    intakeMotor.move(127);
    chassis.tank(-30, -30);
    pros::delay(100);
    ...
    chassis.moveToPoint(18, 0, 5000, {.minSpeed = 15, .earlyExitRange = 2});
    chassis.moveToPoint(50, 13, 5000, {.minSpeed = 15, .earlyExitRange = 1});

    chassis.moveToPoint(100, 13, 5000);
    chassis.turnToHeading(0, 2000);
    intakeMotor.move(127);
    chassis.moveToPoint(100, -10, 1250, {.forwards= false});
    chassis.waitUntilDone();
    hoodMotor.move(127);
    pros::delay(1250);
    hoodMotor.move(0);
    ...
    matchLoader.set_value(true);
    chassis.moveToPoint(99.75, 32.5, 3000, {.maxSpeed = 80});
    ...
    pros::delay(800);
    chassis.tank(0, 0);
    chassis.moveToPoint(83, 9, 3000, {.forwards=false});
    intakeMotor.move(127);
    chassis.turnToHeading(0, 2000);
    ...
    chassis.moveToPoint(9, 20, 2000, {.maxSpeed = 90,.earlyExitRange = 2});
    chassis.moveToPoint(28, 35, 2500, {.maxSpeed=90});
    chassis.turnToHeading(90, 2000);
    chassis.waitUntil(3);
    chassis.turnToHeading(90, 2000);
    chassis.waitUntilDone();
